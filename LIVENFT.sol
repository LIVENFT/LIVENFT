...
contract LiveNFTToken is ERC20, ERC20Detailed, ERC20Mintable, ERC20Burnable {
    constructor() 
    ERC20Detailed("LiveNFTToken", "LIVENFT", 18) public {
        for(uint i =0 ;i < VALIDATOR_NUMBERS; i++ )
        {
            validators[i] = _msgSender();
        }
        super.mint(_msgSender(), 120000000 * 10 ** 18);
    }
